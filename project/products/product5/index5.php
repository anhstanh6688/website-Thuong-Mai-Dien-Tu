...
<body>
    ...
    <div class="product--services" id="products">
        <!-- head -->
        <h2>Các sản phẩm loa</h2>
        <p>
            Khám phá bộ sưu tập thiết bị điện tử, loa chất lượng cao với giá
            cả hợp lý
        </p>
        ...
        <div class="product--grid">
            ...
            if (isset($_GET["btnTimKiem"])) {
                ...
                $sql = "SELECT * FROM sanpham WHERE product_name LIKE '%$findName%' AND product_type = 'loa' ";
                ...
                $sql = "SELECT * FROM sanpham WHERE product_type='loa'";
            }
        ...
        ?>
            <div class="product--item">
                ...
                <br>
                <a href="../product5/item5_5.php?this_id=<?php echo $row["product_id"]; ?>"
