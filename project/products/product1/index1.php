    ...
    <div class="product--services" id="products">
        ...
        <div class="product--grid">
            ...
            if (isset($_GET["btnTimKiem"])) {
                ...
                $sql = "SELECT * FROM sanpham WHERE product_name LIKE '%$findName%' AND product_type = 'tu_lanh' ";
                ...
                $sql = "SELECT * FROM sanpham WHERE product_type='tu_lanh'";
            }
            ...
            ?>
                <div class="product--item">
                    ...
                    <div style="font-size: 13px; margin-top: 5px; color: #333">
                        Quà: <?php echo $row["gift"]; ?>
                    </div>
                    <div class="rating">
                        ⭐ <?php echo $row['rating']; ?> • Đã bán <?php echo $row['sold_count']; ?>
                    </div>
                    <br>
                    <a href="../product1/item1_1.php?this_id=<?php echo $row["product_id"]; ?>"
