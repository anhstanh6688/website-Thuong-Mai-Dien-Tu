...
<body>
    ...
    <div class="product--services" id="products">
        <!-- head -->
        <h2>Các sản phẩm máy giặt</h2>
        <p>
            Khám phá bộ sưu tập thiết bị điện tử, máy giặt chất lượng cao với giá
            cả hợp lý
        </p>
        ...
        <div class="product--grid">
            ...
            <div class="product--item">
                ...
                <br>
                <a href="../product2/item2_2.php?this_id=<?php echo $row["product_id"]; ?>"
