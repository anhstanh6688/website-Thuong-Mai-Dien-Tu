...
<body>
    ...
    <div class="product--services" id="products">
        <!-- head -->
        <h2>Các sản phẩm điều hòa</h2>
        <p>
            Khám phá bộ sưu tập thiết bị điện tử, điều hòa chất lượng cao với giá
            cả hợp lý
        </p>
        ...
        <div class="product--grid">
            ...
            if (isset($_GET["btnTimKiem"])) {
                ...
                $sql = "SELECT * FROM sanpham WHERE product_name LIKE '%$findName%' AND product_type = 'dieu_hoa' ";
                ...
                $sql = "SELECT * FROM sanpham WHERE product_type='dieu_hoa'";
            }
